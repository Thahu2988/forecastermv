...
# WARNING: Replace the placeholder hash with a real one generated by stauth.Hasher()
# Example HASH placeholder (for metmdv@gmail.com's password)
hashed_passwords = ['$2b$12$ABCDEFGHIJKLMNO.PQRSTUVWXYZ.EXAMPLE.HASH.DO.NOT.USE'] 

authenticator = stauth.Authenticate(
    names=['MMS Forecaster'],
    usernames=['metmdv'],
    # Use the real hash generated from your password
...
# --- Check Login Status ---
# 'name' is the full display name, 'authentication_status' is True/False/None
name, authentication_status, username = authenticator.login('Login', 'main')

# ------------------------------------------------
# 2. CONFIGURE PAGE AND UI ONLY IF LOGGED IN
# ------------------------------------------------
if authentication_status:
    # 2A. Page Configuration and UI Hiding
    st.set_page_config(
        ...
        menu_items={'About': 'Developed by Maldives Meteorological Service (MMS)', 
                    'Get Help': None, 
                    'Report a bug': None},
        # Hides GitHub Icon, Edit Icon, and Star Icon
        show_toolbar_by_default=False 
    )

    # 2B. Inject Custom CSS for Header/Buttons and Hiding the Share Button
    st.markdown(
        """
        <style>
...
# ------------------------------------------------
    ...
    st.set_page_config(page_title="Login Required", page_icon="🔒")
